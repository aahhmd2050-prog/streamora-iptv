...
function prepareDirectories(timestamp) {
  ...
  const releaseSource = path.join(projectRoot, 'releases');
  const releaseTarget = path.join(staticBuild, 'releases');
  if (fs.existsSync(releaseSource)) {
    fs.cpSync(releaseSource, releaseTarget, { recursive: true });
    console.log('Copied release files');
  }
